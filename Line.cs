namespace PipingISO
{
    public class Line
    {
        ...
        public bool isLineIntersectAndBehind(Line comparisonLine)
        {
            // 기준 선분의 점
            ...
            if (t >= 0 && t <= 1 && s >= 0 && s <= 1)
            {
                // if (isBehindLine(comparisonLine, t, s))
                // {
                    return true;    
                // }
        ...
        public bool isBehindLine(Line comparisonLine, double t, double s)
        {
            double x3dt = (1 - t) * point1.getX() + t * point2.getX();
            double y3dt = (1 - t) * point1.getY() + t * point2.getY();
            double z3dt = (1 - t) * point1.getZ() + t * point2.getZ();

            double x3ds = (1 - s) * comparisonLine.point1.getX() + t * comparisonLine.point2.getX();
            double y3ds = (1 - s) * comparisonLine.point1.getY() + t * comparisonLine.point2.getY();
            double z3ds = (1 - s) * comparisonLine.point1.getZ() + t * comparisonLine.point2.getZ();
